package com.runjing.wineworld.ui.base.viewmodel;
...
public class ToolbarViewModel<M extends BaseModel> extends BaseViewModel<M> {
    ...
    //标题颜色  默认白色
    public ObservableInt colorBackground = new ObservableInt();
    //标题显示的观察者
    public ObservableInt titleVisibleObservable = new ObservableInt(View.GONE);
    //右边文字的观察者
...
//        StatusBarUtil.setColor(activity, color);
    ...
    public void setTitleVisiable(int visiable) {
        titleVisibleObservable.set(visiable);
    }
