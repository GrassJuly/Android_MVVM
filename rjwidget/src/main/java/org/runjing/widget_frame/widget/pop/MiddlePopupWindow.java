package org.runjing.widget_frame.widget.pop;
...
/**
 * Created by qianxs on 2016/5/11.
 * Describe：
 */
public class MiddlePopupWindow extends PopupWindow {
    ...
    public MiddlePopupWindow builder() throws Exception {

        popupWindow = new MiddlePopupWindow(mContext);
    ...
    public MiddlePopupWindow setTitle(String title) {
        showTitle = true;
    ...
    public MiddlePopupWindow setMsg(String message) {
        showMsg = true;
        tv_msg.setText(message);
        return this;
    }

    public MiddlePopupWindow setNeg(String neg, final View.OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(neg)) {
            btn_neg.setText("取消");
        } else {
    ...
    public MiddlePopupWindow setPos(String pos, final View.OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(pos)) {
            btn_pos.setText("确定");
        } else {
    ...
    public MiddlePopupWindow setEditText(String msg) {
        showEditText = true;
        if ("".equals(msg)) {
            et_input.setHint("内容");
        } else {
