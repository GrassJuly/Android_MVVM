package com.runjing.wineworld.ui.network;
...
import org.rj.bframe.bus.event.SingleLiveEvent;
import org.rj.bframe.http.BaseResponse;
import org.rj.bframe.http.ResponseThrowable;
import org.rj.bframe.utils.RxUtils;
...
public class NetWorkViewModel extends BaseViewModel<AppRepository> {
    ...
    public NetWorkViewModel(@NonNull Application application, AppRepository repository) {
